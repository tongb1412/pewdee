...
?>
	...
	{
	?>
		<a href="javascript: ajaxLoad('get','daily_report/retypepay_list.php','branchid=<?php echo $branch_id; ?>&mode=<?= $mode ?>&Page=<?= $Prev_Page ?>','d_list')">
	...
	{
	?>
		<a href="javascript: ajaxLoad('get','daily_report/retypepay_list.php','branchid=<?php echo $branch_id; ?>&mode=<?= $mode ?>&Page=<?= $Next_Page ?>','d_list')">
