...
<div class="list_out" onmouseover="linkover(this)" onmouseout="linkout(this,'<?=$cl?>')" style="background:<?=$cl?>" >
	...
	<div style="width:10%; float:left; text-align:right;">
	    &nbsp;<img src="images/icon/import16.png" align="คนไข้ในระบบ" title="คนไข้ในระบบ" style="cursor:pointer;" onClick="ajaxEdit('post','setting/offpatient.php','cn=<?=$rs['hn']?>&mode=on','settingpage');"/>
	</div>
...
<div style="width:99%; margin:auto; margin-top:10px; text-align:right; line-height:20px;">
 <?=$Num_Rows;?> 
  ...
  <?
	...
	{
	?>
	<a href="javascript: ajaxLoad('get','setting/pout_list.php','txt=<?=$txtserch?>&Page=<?=$Prev_Page?>','p_list')">	
	...
	for($i=1; $i<=$Num_Pages; $i++){
		...
		{
	?>		
	<a href="javascript: ajaxLoad('get','setting/pout_list.php','txt=<?=$txtserch?>&Page=<?=$i?>','p_list')"><?=$i?></a>	
	<?
		}
		else
		{ 	
	...
	<a href="javascript: ajaxLoad('get','setting/pout_list.php','txt=<?=$txtserch?>&Page=<?=$Next_Page?>','p_list')">	
