...
?>
<div class="list_out" onmouseover="linkover(this)" onmouseout="linkout(this,'<?=$cl?>')" style="background:<?=$cl?>; width:90%; cursor:pointer;" onclick="instock_movetxt('<?=$rs['did']?>','<?=$rs['tname']?>','<?=$rs['unit']?>','P')" >
