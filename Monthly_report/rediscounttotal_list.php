...
?>
    <div style="width:1700px; height:20px; padding-top:5px; color:#000000; margin:auto;  font-weight:bold; font-size:12px; background:<?=$tabcolor?>;">
	  ...
	  <div style="width:9%;text-align:left; float:left;">&nbsp;<img src="images/icon/bullet_arrow_down.png" align="absmiddle" />&nbsp;ส่วนลด</div>	
	  
	  <div style="width:9%;text-align:left; float:left;">&nbsp;<img src="images/icon/bullet_arrow_down.png" align="absmiddle" />&nbsp;รับเงิน</div>
...
<div class="list_out" onmouseover="linkover(this)" onmouseout="linkout(this,'<?=$cl?>')" style="width:1700px;;background:<?=$cl?>; ">
	...
	<div style="width:9%; float:left;"><?=number_format($rs['discount'],'0','.',',')?></div>
	
	<div style="width:9%; float:left;"><?=number_format($recive,'0','.',',')?></div>
