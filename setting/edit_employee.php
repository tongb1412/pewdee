...
?>
		   ...
		   <div class="line">
		 	...
		 	<div class="line">
				...
				<div style="width:25%; float:left;"><input type="text" id="lname" size="15" value="<?=$row['lname']?>" /></div>	
			...
			<div class="line"> 
				...
				<div style="width:25%; float:left;">
					<input type="text" id="dd" size="2" style="width:22px"  maxlength="2" value="<?=substr($row['birthday'],0,2)?>" />-<input type="text" id="dm" size="2" style="width:22px" maxlength="2" value="<?=substr($row['birthday'],3,2)?>" />-<input type="text" id="dy" size="4" style="width:35px" maxlength="4" value="<?=substr($row['birthday'],6,4)?>" /> </div>
	    		<div style="width:25%; float:left; text-align:right;">บัตรประชาชน :&nbsp;</div>
				<div style="width:25%; float:left;"><input type="text" id="idcard" size="15" value="<?=$row['idcard']?>" /></div>
				</div>	<!--วัน เดือน ปี เกิด-->
    ...
    <div class="line">
      ...
      <div style="width:25%; float:left;">
        <input  type="password" id="pass"  size="15" value="<?=$row['pass']?>" />
     </div>
    </div>  			<div class="line">&nbsp;</div>
			
			<div class="line"> 
				<div style="width:21%; float:left; text-align:right;">ที่อยู่ :&nbsp;</div>
				<div style="width:25%; float:left;"><input type="text" id="address" size="51" value="<?=$row['address']?>" /></div>	
			</div> <!--ที่อยู่-->
			...
			<div class="line"> 
				...
				<div style="width:25%; float:left;"><input type="text" id="mail" size="15" value="<?=$row['email']?>" /></div>
		    </div> <!--เบอร์่-->
			...
			<div class="line">
				<div style="width:21%; float:left; text-align:right;">วันเริ่มทำงาน :&nbsp;</div>
	  			...
	  			<div style="width:25%; float:left;"><input type="text" id="dday" size="15" value="<?=$row['']?>" /></div>
			</div> <!--วันที่เริ่มทำงาน-->
			...
			<div class="line">
				<div style="width:21%; float:left; text-align:right;">สิทธิวันลา :&nbsp;</div>
	  			...
	  			<div style="width:25%; float:left;"><input type="text" id="acc" size="15" value="<?=$row['acc_number']?>" /></div>
			</div> <!--สิทธิวันลา-->
			...
			<div class="line">
				...
				<div style="width:25%; float:left;">
	 			...
	 			<div style="width:25%; float:left; text-align:right;">เลขที่ประกันสังคม :&nbsp;</div>
	  			<div style="width:25%; float:left;"><input type="text" id="ssonum" size="15" value="<?=$row['sso_on']?>" /></div>
			</div> <!--สิทธิวันลา-->
