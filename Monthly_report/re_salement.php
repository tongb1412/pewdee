...
$sql .= "from tb_pctrec a,tb_patient  b, tb_clinicinformation c where (a.hn = b.hn) and  (a.dat between '$sdate%' and '$edate%') and (a.typ ='T' or typ ='L') and a.branchid = c.cn " . $where_branch_id;
} else {
$sql  = "select a.*,b.cradno,b.pname,b.fname,b.lname, c.cn, c.clinicname ";
$sql .= "from tb_pctrec a,tb_patient  b, tb_clinicinformation c where (a.hn = b.hn) and  (a.dat between '$sdate%' and '$edate%') and (a.typ ='T' or typ ='L') and (a.empid like '%$did%') and a.branchid = c.cn " . $where_branch_id;
}
