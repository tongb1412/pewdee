...
$sql .= "from tb_pctrec a,tb_patient  b, tb_clinicinformation c where (a.hn = b.hn) and  (a.dat like '%$dat%') and (a.typ ='P' ) and a.branchid = c.cn " . $where_branch_id;
} else {
$sql  = "select a.*,b.cradno,b.pname,b.fname,b.lname, c.cn, c.clinicname ";
$sql .= "from tb_pctrec a,tb_patient  b, tb_clinicinformation c where (a.hn = b.hn) and  (a.dat like '%$dat%') and (a.typ ='P' ) and (a.empid like '%$did%') and a.branchid = c.cn " . $where_branch_id;
}
