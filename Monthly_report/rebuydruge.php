...
<div id="t_main" class="tmain" style="width:100%; height:495px; overflow:hidden;">
  ...
  <div style="width:95%; margin-top:10px; margin-left:20px; text-align:left; height:10%; background-color:#FFCC99; overflow:auto; border:<?=$tabcolor?> 1px solid;">
	 <div class="line" style="margin-top:5px; width:60%;">
      	...
      	<div style="width:19%; float:left; margin-top:10px;">&nbsp;<!--<input type="text" id="sdate" size="8" maxlength="10" onkeyup="forDate(this)"   />--></div>
	  	<div style="width:6%; float:left; margin-top:10px; text-align:right; line-height:20px; font-size:14px; ">&nbsp;</div>
      	<div style="width:19%; float:left; margin-top:10px;">&nbsp;<!--<input type="text" id="edate" size="8" maxlength="10" onkeyup="forDate(this)"   />--></div>
