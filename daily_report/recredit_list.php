...
<div style="width:83%; margin:auto; margin-top:10px; text-align:right; line-height:20px;">
	...
	{
		?>
		<a href="javascript: ajaxLoad('get','daily_report/recredit_list.php','branchid=<?php echo $branch_id; ?>&mode=<?= $mode ?>&Page=<?= $Prev_Page ?>','d_list')">
	...
	if($Page!=$Num_Pages)
	{
		...
		<a href="javascript: ajaxLoad('get','daily_report/recredit_list.php','branchid=<?php echo $branch_id; ?>&mode=<?= $mode ?>&Page=<?= $Next_Page ?>','d_list')">
