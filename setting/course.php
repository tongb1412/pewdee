...
<div id="t_main" class="tmain" style="width:100%; margin:auto; height:495px; overflow:hidden; text-align:center ">
  <div class="littleDD" style="font-size:14px; font-weight:bold;" >สร้างรายการคอร์ส</div>
  ...
  <input type="button" value="  สร้างรายการใหม่  " onClick="ajaxLoad('post','setting/new_course.php','','clist')">
  </div>
...
<div class="list_out" onmouseover="linkover(this)" onmouseout="linkout(this,'<?=$cl?>')" style="width:96%; margin:auto; background:<?=$cl?>">
	...
	<div style="width:15%; float:left;"><?=$rs['cid']?></div>
	<div style="width:45%; float:left;"><?=$rs['cname']?></div>
	...
	<img src="images/icon/pedit.png" align="แก้ไขข้อมูล" title="แก้ไขข้อมูล" style="cursor:pointer;" onClick="ajaxLoad('post','setting/new_course.php','cid=<?=$rs['cid']?>','clist')" />
	<img src="images/icon/pdelete.png" align="ลบข้อมูล" title="ลบข้อมูล" style="cursor:pointer;" onClick="ConfDelete('setting/course_del.php','settingpage','id=<?=$rs['cid']?>')" />
	</div>
</div>
<? } ?>
...
<div style="width:100%; margin:auto; margin-top:10px; text-align:right; line-height:20px;">
 <?=$Num_Rows;?> 
  ...
  <?
	...
	{
	?>
	<a href="javascript: ajaxLoad('get','setting/course.php','mode=<?=$mode?>&Page=<?=$Prev_Page?>','settingpage')">	
	...
	<a href="javascript: ajaxLoad('get','setting/course.php','mode=<?=$mode?>&Page=<?=$Next_Page?>','settingpage')">	
