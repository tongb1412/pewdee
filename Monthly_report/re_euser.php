...
if(empty($did)){
$sql = "select a.totalprice,b.tid,b.pid,b.ftyp,b.typ,b.dat,b.tname,b.qty,b.empid,b.ename,c.cradno,c.pname,c.fname,c.lname,(a.totalprice / a.qty) priceunit,((a.totalprice / a.qty)*b.qty) price ";
...
?>
    ...
    <div style="width:100%; height:30px; line-height:25px; text-align:center; font-size:10px; font-weight:bold;  float:left;">
      ...
      <div style="width:22%; float:left; text-align:left; border-bottom:#999999 2px solid;">รายการ</div>
      <div style="width:10%; float:left; border-bottom:#999999 2px solid;">จำนวน</div>
      <div style="width:20%; float:left; text-align:left; border-bottom:#999999 2px solid;">ชื่อลูกค้า</div>
      <div style="width:10%; float:left; border-bottom:#999999 2px solid;">ราคา</div>
	  <div style="width:10%; float:left; text-align:left; border-bottom:#999999 2px solid;">ประเภท</div>
	  <div style="width:10%; float:left; text-align:left; border-bottom:#999999 2px solid;">วันที่</div>	  
	</div>			
 <? 
 $s='n';
 }
...
<div  style="width:100%; font-size:10px; text-align:left; float:left; margin:auto; overflow:hidden;  ">
	...
	<div style="width:22%; float:left; text-align:left;"><?=$rs['tname']?></div>	
	<div style="width:10%; float:left;">&nbsp;<?=number_format($rs['qty'],'0','.',',')?></div>
	<div style="width:20%; float:left; text-align:left;"><?=$rs['pname'].$rs['fname'].'    '.$rs['lname']  ?></div>
	<div style="width:10%; float:left; text-align:right">&nbsp;<?=number_format($price,'0','.',',')?>&nbsp;&nbsp;&nbsp;&nbsp</div>
	<div style="width:10%; float:left; text-align: left;"><?=$ftype?></div>	
    <div style="width:10%; float:left; text-align: left;"><?= $rs['dat'];?></div>
</div>	
<? 
