...
if(empty($_GET['an'])){
	...
	$str = mysql_query($sql) or die ("Error Query [".$sql."]"); 
	$rs=mysql_fetch_array($str); 
	if($rs['atyp']=='A'){ $dis='none';  } else { $dis=''; } 
...
<div style="width:60%; height:40px; margin:auto; margin-top:10px; border:<?=$tabcolor?> 1px solid; line-height:20px;">
	...
	<div class="line" style="margin-top:10px;" >
        ...
        <input type="text" id="txtserch" size="67" onkeyup="serchlab('appointment/patient_list.php','ll',this)"  />
...
<div style="width:60%; height:100px; margin:auto; margin-top:10px; border:<?=$tabcolor?> 1px solid; line-height:10px; background:<?=$tabcolor?>;">
	...
	<div class="line">
        ...
        <input type="text" id="pname" size="68" readonly="true" value="<?=$rs['pname']?>"/>
        </div>	
				
	</div>
</div>
<div style="width:60%; height:250px; margin:auto; margin-top:10px; border:<?=$tabcolor?> 1px solid; line-height:10px;">
	<div class="line" style="margin-top:10px;" >
	...
	<div class="line" style="margin-top:10px;" >
        ...
        <? } ?>
		 ...
		 <div>&nbsp;&nbsp; เวลา : &nbsp;<input type="text" id="atime" value="<?=$rs['atime']?>">&nbsp;นาฬิกา (ตย.12:30) </div>
	</div>
   
	<div class="line"  style="margin-top:10px; height:110px;" >
