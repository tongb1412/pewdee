...
<div style="width:99%; height:auto; margin:auto; text-align:center;">
		...
		?>
			<div class="line" style="margin-top: 2%;">
				...
				<div style="width:30%; float:left; margin:auto">
					...
					$result = mysql_query($sql) or die("Error Query [" . $sql . "]");
					?>
					<select name="select" id="branchid" style="width:120px;" onchange="serchtxt('promotion/promotion_list1.php','d_tall','')">
	...
	<div id="promotionpage" class="main" style="float:left; margin:auto; width:60%; height:495px; margin-left:5px;">
		...
		<div id="staffedit" style="width:98%; height:470px;  margin-top:5px; margin-left:5px; float:left; background:#CCCCCC">
			...
			<div class="line">
				...
				<div style="width:25%; float:left;">
					<input name="text2" type="text" id="proname" size="40" />
				</div>
			</div>
