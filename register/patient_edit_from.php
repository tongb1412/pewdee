...
<div style="width:45%; height:470px; float:left;">
	<div class="line">
...
<div style="width:41%; height:470px; margin-left:1%; float:left; ">
	<?
...
?>
	...
	<div class="line" style="height:80px;">
		<div style="width:20%; float:left; text-align:right;">:&nbsp;</div>
		<div style="width:80%; float:left;"><textarea id="mem" cols="36" rows="3"><?= $row['mem'] ?></textarea></div>
...
?>
	...
	<div class="line" style="border-bottom:#CCCCCC 1px dotted;">
		...
		<div style="width:80%; float:left;">
			...
			&nbsp;&nbsp;อื่นๆ : <input type="text" id="other" size="11" value="<?= $row["other"]; ?>" />
		</div>
	</div>
