...
$sql = "select a.*,b.cradno,b.pname,b.fname,b.lname,(a.total - a.discount) tot from tb_payment a,tb_patient  b where (a.hn = b.hn) and  (a.pdate like '%$dat%') ";
...
?>
	...
	<div style="width:15%; float:left;">&nbsp;<?=number_format($rs['cash'],'2','.',',')?></div>
	<div style="width:15%; float:left;">&nbsp;<?=number_format($rs['credit'],'2','.',',')?></div>
	<div style="width:15%; float:left;">&nbsp;<?=number_format($rs['tot'],'2','.',',')?></div>
