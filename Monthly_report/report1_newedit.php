...
<TABLE  x:str BORDER="1">
	...
	<TR valign="bottom">
		...
		<TD align="center" align="center"><b>CO2 +KA (ถ้ามุมซ้ายล่าง/คอลั่มมีสีเขียว=30%)</b></TD>
		<? // 0. ?>
	   <TD align="center" colspan="3" align="center"><b>30%-Made, Meso Fat, M Solution</b></TD>
		...
		<? // 4. ?>
		<TD align="center" colspan="2" align="center"><b>30% Fraxel Golden S EMatrix </b></TD>
		<? // 5. ?>
		<TD align="center"  align="center"><b>10% Ulthera Thermage HIFUครั้ง</b></TD>
		<? // 6. ?>
		<TD align="center"  align="center"><b>10% Treatment Face</b></TD>
		<? // 7. ?>
		<TD align="center"  align="center"><b>10% Treatment Body</b></TD>
		<? // 7.5 ?>
		<TD align="center"  align="center"><b>10% Pico</b></TD>
		<? // 8. ?>
	...
	while($rs=mysql_fetch_array($str)){
	   ...
	   if(!empty($num)){
		...
		for($l = 0;$l < $gnum; $l++){
            ...
            //5.  10% Ulthera Thermage HIFUครั้ง
            if($tgid == '1000008'){
            	if($t2!=''){ $s5 = $s5 + $t2; }
            	if($t3!=''){ $s5 = $s5 + $t3; }
            	$s5 = $s5 * 0.1;
		...
		//รวมยอดรายวัน
		$sum_total = $sum_total + $co2 + $s0 + $s1 + $s2 + $s3 + $s4 + $s5 + $s6 + $s7 + $s8 + $s9;
		?>
