...
if(empty($_REQUEST['txt'])){
	$sql = "select * from tb_patient a,tb_vst b where a.hn = b.hn and b.status = 'DOC' and b.company_code = '$company_code' and b.branchid = '$branch_id' ";
} else {
	$txtserch = $_REQUEST['txt'];
	$sql = "select * from tb_patient a,tb_vst b where (a.hn = b.hn) and (b.status = 'DOC') and (a.cradno like '%$txtserch%' or a.hn like '%$txtserch%' or a.fname like '%$txtserch%' or a.lname like '%$txtserch%') and b.company_code = '$company_code' and b.branchid = '$branch_id'";
}
