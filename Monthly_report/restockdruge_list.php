...
<div style="width:83%; margin:auto; margin-top:10px; text-align:right; line-height:20px;">
 <?=$Num_Rows;?> 
  ...
  <?
	...
	{
	?>
	<a href="javascript: ajaxLoad('post','Monthly_report/restockdruge_list.php','Page=<?=$Prev_Page?>&sdate=<?=$sdate?>&edate=<?=$edate?>&did=<?=$_POST['did']?>','d_list')">	
	...
	<a href="javascript: ajaxLoad('post','Monthly_report/restockdruge_list.php','Page=<?=$Next_Page?>&sdate=<?=$sdate?>&edate=<?=$edate?>&did=<?=$_POST['did']?>','d_list')">	
