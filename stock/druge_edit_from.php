...
<div style="width:100%; height:470px; margin:auto; margin-top:20px; text-align:center;">
	...
	<div style="width:45%; height:440px; margin:auto; float:left; margin-left:20px; ">
		<div class="line">
			...
			<div style="width:30%; float:left; margin-right: 3%"><input type="text" id="did" size="20" value="<?= $did ?>" /></div>
			<div style="width:20%; float:left; text-align:right;">Barcode :&nbsp;</div>
			<div style="width:20%; float:left;"><input type="text" id="bcode" size="15" value="<?= $row['barcode'] ?>" /></div>
		</div>
		<div class="line">
			<div style="width:20%; float:left; text-align:right;">ชื่อสามัญทางยา :&nbsp;</div>
			<div style="width:80%; float:left;"><input type="text" id="gname" size="49" value="<?= $row['gname'] ?>" /></div>
		</div>
		<div class="line">
			<div style="width:20%; float:left; text-align:right;">ชื่อทางการค้า :&nbsp;</div>
			<div style="width:80%; float:left;"><input type="text" id="tname" size="49" value="<?= $row['tname'] ?>" /></div>
		</div>
...
?>
		<div class="line">
			...
			<div style="width:30%; float:left; margin-right: 3%"><input type="text" id="total" size="20" value="<?= $row['total'] ?>" readonly="true" style="background:#CCCCCC; border:1px solid #CCCCCC" /></div>
			<div style="width:20%; float:left; text-align:right;">หน่วย :&nbsp;</div>
			<div style="width:25%; float:left;">
				<select id="unit" style="width:121px;">
		...
		<div class="line">
			...
			<div style="width:30%; float:left; margin-right: 3%"><input type="text" id="bprice" size="20" value="<?= $row['bprice'] ?>" readonly="true" sstyle="background:#CCCCCC; border:1px solid #CCCCCC" /></div>
			<div style="width:20%; float:left; text-align:right;">ราคาขาย :&nbsp;</div>
			<div style="width:25%; float:left;"><input type="text" id="sprice" size="12" value="<?= $row['sprice'] ?>" /></div>
		</div>
		<div class="line">
