...
?>
  ...
  <div id="t_main_monthly" class="tmain h-100">
      ...
      <div style="width:95%; margin-top:10px; margin-left:20px; text-align:left; height:10%; background-color:#FFCC99; overflow:auto; border:<?= $tabcolor ?> 1px solid;">
        <div class="line" style="margin-top:5px">
          ...
          <div style="width:30%; float:left; margin-top: 0.9%;">
            <input name="button" type="button" style="font-size:14px; font-weight:bold; height:28px;" onclick="showPatient();" value=" แสดงรายงาน " />
    ...
    ?>
      <div style="width:95%; margin-top:10px; margin-left:20px; text-align:left; height:10%; background-color:#FFCC99; overflow:auto; border:<?= $tabcolor ?> 1px solid;">
        <div class="line" style="margin-top:5px">
          ...
          <div style="width:20%; float:left;" class="center-line">
            <input name="button" type="button" style="font-size:14px; font-weight:bold; height:28px;" onclick="printpatient()" value="  พิมพ์รายงาน  " />
          </div>
        </div>
      </div>
    ...
    ?>
    <div id="d_list" style="width:100%; height:80%; margin-top:5px; margin-left:10px; float:left;  border:<?= $tabcolor ?> 1px solid;">
