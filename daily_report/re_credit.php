...
$sql .=" $where_branch_id order by a.branchid,a.billno asc ";
...
while($rs = mysql_fetch_array($result)){  
	...
	<div style="width:100%; font-size:10px; text-align:left; float:left; margin:auto; ">
		...
		<div style="width:16%; text-align:left; float:left; margin-left:2%;"><?= $rs['creditname'] ?>&nbsp;&nbsp;</div>
		<div style="width:13%; text-align:left; float:left; margin-left:6%;"><?= $rs['credittype'] ?>&nbsp;&nbsp;</div>
