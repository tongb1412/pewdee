...
<div style="width:83%; margin:auto; margin-top:10px; text-align:right; line-height:20px;">
 <?=$Num_Rows;?> 
  ...
  <?
	...
	{
	?>
	<a href="javascript: ajaxLoad('get','daily_report/repayment_list.php','mode=<?=$mode?>&Page=<?=$Prev_Page?>','d_list')">	
	...
	<a href="javascript: ajaxLoad('get','daily_report/repayment_list.php','mode=<?=$mode?>&Page=<?=$Next_Page?>','d_list')">	
