...
$sqlG = "select * from tb_gernaral where typ= 'GTC' ";
...
<div  style="width:68%; height:auto; float:left; text-align:center; margin-left:10px; ">
		...
		<div class="line">
    	<div style="width:17%; float:left; text-align:right;">กลุ่ม :&nbsp;</div>
		<div style="width:80%; float:left;">
		<select id="cgroup" >
        <? while($rsG = mysql_fetch_array($strG)){ ?>
		<option value="<?=$rsG['id']?>" <? if($cgroup==$rsG['id']){?> selected="selected" <? }?> ><?=$rsG['name']?></option>
        <? }?>
