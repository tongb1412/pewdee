...
<div id="t_main" class="tmain" style="width:100%; height:495px; overflow:hidden;">
		...
		<div style="width:95%; margin-top:10px; margin-left:20px; text-align:left; height:28%; overflow:auto; border:<?=$tabcolor?> 1px solid;">
			...
			<div class="line">
				...
				<div style="width:14%; float:left;">&nbsp;<input type="text" id="disdrug" size="10" value="0">&nbsp;% </div>
				<div style="width:20%; float:left; text-align:right; line-height:20px;">ส่วนลดแล็บ/หัตถการ :  </div>
				<div style="width:14%; float:left;">&nbsp;<input type="text" id="dislab" size="10" value="0">&nbsp;% </div>
				<div style="width:15%; float:left; text-align:right; line-height:20px;">ส่วนลดเลเซอร์ :  </div>
				<div style="width:14%; float:left;">&nbsp;<input type="text" id="dislaser" size="10" value="0">&nbsp;% </div>
			</div>
			<div class="line">
				<div style="width:20%; float:left; text-align:right; line-height:20px;">ส่วนลดทรีทเม้นท์ :    </div>
				<div style="width:14%; float:left;">&nbsp;<input type="text" id="distr" size="10" value="0">&nbsp;% </div>
				<div style="width:20%; float:left; text-align:right; line-height:20px;">ส่วนลดคอร์ท :  </div>
				<div style="width:14%; float:left;">&nbsp;<input type="text" id="disco" size="10" value="0">&nbsp;% </div>
				<div style="width:15%; float:left; text-align:right; line-height:20px;">ส่วนลดแพ็คเกจ :  </div>
				<div style="width:14%; float:left;">&nbsp;<input type="text" id="dispg" size="10" value="0">&nbsp;% </div>
			</div>
