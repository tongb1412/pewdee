  ...
  <div class="littleDD" style="font-size:14px; font-weight:bold;" >รายงานรวมการขายคอร์ส</div>
   <div style="width:95%; margin-top:10px; margin-left:20px; text-align:left; height:10%; background-color:#FFCC99;  border:<?=$tabcolor?> 1px solid;">
	 <div class="line" style="margin-top:5px; width:65%;">
		...
		<div style="width:15%; float:left; margin-top:10px; text-align:right; line-height:20px; font-size:14px; ">เลือกผู้ขาย : </div>
		 <?
				$sql = "select staffid,pname,fname from tb_staff  ";
				$result = mysql_query($sql) or die ("Error Query [".$sql."]"); 
				?>
	  
      <div style="width:24%; float:left; margin-top:10px; font-size:14px; ">&nbsp;&nbsp;
