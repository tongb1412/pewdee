...
$sql .= "from tb_pctrec  where   (dat between '$sdate%' and '$edate%') and (typ ='T' or typ ='L') ";
} else {
$sql  = "select  empid,empname,tid,tname,sum(totalprice) totalprice,count(*) qty ";
$sql .= "from tb_pctrec  where   (dat between '$sdate%' and '$edate%') and (typ ='T' or typ ='L') and (empid like '%$did%') ";
}
