...
$cl = $color1;
$sql = "select a.*,b.cradno,b.pname,b.fname,b.lname,(a.total - a.recive) aa  from tb_payment a,tb_patient  b,tb_vst c where (a.hn = b.hn) and (a.vn=c.vn) and (a.pdate between '$sdate%' and '$edate%')  and (c.status='COM') ";
...
include('../class/config.php');
$dat = date('d-m-Y',time());
$sql = "select sum(a.cash) s_cash ,sum(a.credit) s_credit,sum(a.recive) s_total from tb_payment a,tb_vst b where (a.pdate between '$sdate%' and '$edate%') and  (a.vn=b.vn) and (b.status='COM') "; 
