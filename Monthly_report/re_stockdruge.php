...
$sql  = "select * from tb_druge where status = 'IN'  order by dgroup,typname,tname asc ";
$str  = mysql_query($sql);
...
.txt1 { font-size:12px; font-weight:bold; height:25px; line-height:25px; }
.lineH { border-bottom:#999999 1px solid; font-size:12px; line-height:20px; height:20px; overflow:hidden; }
...
.tline { border:1px solid #333333; border-right:none; overflow:hidden; text-align:center; height:20px; line-height:20px; font-size:11px; }
.tr { overflow:hidden; border:1px solid #333333; text-align:center; height:20px; line-height:20px; font-size:11px; }


.tlineD { border:1px solid #333333; border-right:none; border-top:none; overflow:hidden; text-align:center; height:20px; line-height:20px; font-size:11px; }
.trD { overflow:hidden; border:1px solid #333333; border-top:none; text-align:center; height:20px; line-height:20px; font-size:11px; }
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
    ...
    <tr><td align="center" class="txt1">&nbsp;</td></tr>
...
?>
		<td align="center" width="50%" valign="top">
            ...
            <td class="tlineD" width="30" style="text-align:right"><?=$rs['total']?>&nbsp;</td>
