	...
	<script data-id="App.Scripts">
		App.Scripts = {
			...
			plugins_dependency: [
				...
				'assets/library/jquery-ui/js/jquery-ui.min.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				'assets/library/jquery/jquery-migrate.min.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				'assets/plugins/tables_datatables/js/jquery.dataTables.min.js?v=v1.0.0-rc1&sv=v0.0.1.2'
			],
			...
			plugins: [
				...
				'assets/plugins/tables_datatables/extras/TableTools/media/js/TableTools.min.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				'assets/plugins/tables_datatables/extras/ColVis/media/js/ColVis.min.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				'assets/components/tables_datatables/js/DT_bootstrap.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				'assets/plugins/forms_elements_bootstrap-select/js/bootstrap-select.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				'assets/plugins/tables_datatables/extras/FixedHeader/FixedHeader.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				'assets/plugins/tables_datatables/extras/ColReorder/media/js/ColReorder.min.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				...
				'assets/plugins/core_jquery-ui-touch-punch/jquery.ui.touch-punch.min.js?v=v1.0.0-rc1&sv=v0.0.1.2'
			],
			...
			bundle: [
				...
				'assets/components/tables_datatables/js/datatables.init.js?v=v1.0.0-rc1&sv=v0.0.1.2',
				...
				'assets/components/tables/tables-classic.init.js?v=v1.0.0-rc1&sv=v0.0.1.2',
...
-moz-opacity:0.5; ">
	...
	<div id="sidebar-left" class="sidenav">
		...
		<div class="brand ng-scope">
			...
			<div class="brand-logo">
				<img data-ng-src="images/logo.png" height="15" alt="" style="display: none;" src="images/logo.png">
			</div>
			<!-- /logo -->

			<!-- toggle small sidebar menu -->
			<div id="side_menu_header_title">
				<br />
				<span>
					Pewdee Clinic System
				</span>
			</div>
			<!-- /toggle small sidebar menu -->
		...
		<ul class="menu list-unstyled">
			<li>
				<a href="javascript: loadmodule('home','register/register.php','')" class="">
			...
			<li>
				<a href="javascript: loadmodule('home','doctor/doctor.php','')" class="">
					<img src="images/doctor.png" alt="home" class="side-menu-icon" />
					<span>&nbsp;ตรวจรักษา</span>
				</a>
			</li>

			<li class="hasSubmenu " id="daily_report_side_menu">
				...
				<ul class="collapse sub-menu" id="sub-menu-daily-report-1">
					<li>
						<a class="sub-menu-btn" data-toggle="collapse" href="#sub-menu-daily-report-1-sub-1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
					...
					<li>
						<a class="sub-menu-btn" data-toggle="collapse" href="#sub-menu-daily-report-1-sub-2" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
							<span>รายงานรวม</span>
							<i class="fa fa-caret-down" aria-hidden="true"></i>
						</a>
					...
					<li>
						<a class="sub-menu-btn" data-toggle="collapse" href="#sub-menu-daily-report-1-sub-3" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
					...
					<li>
						<a class="sub-menu-btn" data-toggle="collapse" href="#sub-menu-daily-report-1-sub-4" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
					...
					<li>
						<a class="sub-menu-btn" data-toggle="collapse" href="#sub-menu-daily-report-1-sub-5" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
							<span>อื่น ๆ</span>
							<i class="fa fa-caret-down" aria-hidden="true"></i>
						</a>
			...
			<li>
				<a href="javascript: loadmodule('home','promotion/promotion.php','')" class="">
			...
			<li>
				<a href="javascript: loadmodule('home','stock/stock_show.php','');" class="">
					<img src="images/addstock.png" alt="home" class="side-menu-icon" />
					<span>&nbsp;&nbsp;ยาคงคลัง</span>
				</a>
			</li>

			<li class="hasSubmenu " id="monthly_report">
				...
				<ul class="collapse sub-menu" id="sub-menu-monthly-report-1">
					...
					<li>
						<a class="" data-toggle="collapse" href="#sub-menu-monthly-report-1-sub-1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
							<span>รายงานคนไข้</span>
							<i class="fa fa-caret-down" aria-hidden="true"></i>
						</a>
					...
					<li>
						<a class="" data-toggle="collapse" href="#sub-menu-monthly-report-1-sub-2" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
							<span>รายงานรายได้</span>
							<i class="fa fa-caret-down" aria-hidden="true"></i>
						</a>
					...
					<li>
						<a class="" data-toggle="collapse" href="#sub-menu-monthly-report-1-sub-3" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
							<span>รายงานยา</span>
							<i class="fa fa-caret-down" aria-hidden="true"></i>
						</a>
					...
					<li>
						<a class="" data-toggle="collapse" href="#sub-menu-monthly-report-1-sub-4" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
							<span>รายงานรวม</span>
							<i class="fa fa-caret-down" aria-hidden="true"></i>
						</a>
			...
			<li>
				<a href="javascript: stockFunc()" class="">
			...
			<li>
				<a href="javascript: loadmodule('home','setting/setting.php','')" class="">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			// dataTable in stock.php
			// $('#stock_druge_table').DataTable({
		...
		function stockFunc(){
			loadmodule('home','stock/stock.php','');
