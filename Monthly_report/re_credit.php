...
?>
    ...
    <div style="width:100%; height:30px; line-height:25px; text-align:center; font-size:10px; font-weight:bold;  float:left;">
      ...
      <div style="width:18%; float:left; border-bottom:#999999 2px solid;">ชื่อ-สกุล</div>
      <div style="width:18%; float:left; border-bottom:#999999 2px solid;">ชื่อบัตร</div>
      <div style="width:19%; float:left; border-bottom:#999999 2px solid;">เลขที่บัตร</div>
      <div style="width:21%; float:left; border-bottom:#999999 2px solid;">จำนวนเงิน</div>
	  <div style="width:10%; float:left; border-bottom:#999999 2px solid;">เลขที่ใบเสร็จ</div>
	</div>		
...
<div  style="width:100%; font-size:10px; text-align:left; float:left; margin:auto; ">
	...
	<div style="width:23%; text-align: left; float:left;"><?=$rs['creditname'].'  '.$rs['pdate']?>&nbsp;&nbsp;</div>
	<div style="width:18%; text-align:left; float:left;"><?=$rs['credittype']?>&nbsp;&nbsp;</div>
	<div style="width:10%; text-align:right; float:left;"><?=number_format($rs['credit'],'2','.',',')?>&nbsp;&nbsp;</div>
	<div style="width:15%; float:left; text-align:center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$rs['billno']?></div>
