...
<div id="t_main" class="tmain" style="width:100%; height:495px; overflow:hidden;">
  ...
  <div style="width:95%; margin-top:10px; margin-left:20px; text-align:left; height:<?=$css_height?>%; border:<?= $tabcolor ?> 1px solid; background-color: #FFD1A4;">
    ...
    <div style="width:40%; float:left;margin-top:10px;<?=$margin_left?>">
      <input name="button" type="button" style="font-size:14px; font-weight:bold; height:28px;" onclick="mpatient('Monthly_report/totalcash_list.php','d_list')" value=" แสดงรายงาน " />
      <input name="button" type="button" style="font-size:14px; font-weight:bold; height:28px;" onclick="printmonth('Monthly_report/re_totalcash.php?')" value=" พิมพ์รายงาน " />
      <input type="button" style="font-size:14px; font-weight:bold; height:28px;" onclick="printcredit('Monthly_report/rep_cash_excel.php?')" value=" Excel" />
    </div>
  </div>
