...
<div id="t_main" class="tmain" style="width:100%; margin:auto; height:495px; overflow:hidden;  ">
	...
	<?php 
        if ($_SESSION['company_data'] == "1" ) {
          ...
          <div class="littleDD" style="width:40%; float:left;font-weight:bold;text-align:center; line-height:20px; font-size:14px;">คนไข้นอกระบบ</div>
          ...
          <select name="select" id="branchid" style="width:117px;height: 21px;" onchange="mpatient2('daily_report/pin_list.php','d_list')">
	...
	<?php
			...
			echo '<div class="littleDD" style="font-size:14px; font-weight:bold;">คนไข้นอกระบบ</div>';
	...
	<div style="width:47%; height:450px;  float:left; margin-left:10px; margin-top:10px; margin-right:10px;  border:<?= $tabcolor ?> 1px solid;">
		...
		<div id="content" style=" width:100%; margin-top:5px; text-align:center; height:auto;">
			...
			<div class="txt_serch">
				<input class="input_serch" type="text" id="txts" size="41" value="ค้นหา" onclick="clickclear(this, 'ค้นหา')" onblur="clickrecall(this,'ค้นหา')" onkeyup="serchtxt('daily_report/pin_list.php','p_list',this)" /><input type="button" class="btn_serch" onclick="ajaxLoad('get','stock/druge_list.php','txt=','p_list')" />
			</div>
			...
			<div style="width:99%; height:20px; padding-top:5px; color:#000000; margin:auto; font-weight:bold; font-size:13px; background:<?= $tabcolor ?>;">
				<div style="width:25%;  text-align:left; float:left;"><img src="images/icon/bullet_arrow_down.png" align="absmiddle" />&nbsp;Cardno</div>
	...
	<div style="width:47%; height:450px;  float:left; margin-left:5px; margin-top:10px;  margin-right:10px; border:<?= $tabcolor ?> 1px solid;">
		...
		<div id="content1" style=" width:100%; margin-top:5px; text-align:center; height:auto;">
			...
			<div class="txt_serch">
				<input class="input_serch" type="text" id="txts" size="41" value="ค้นหา" onclick="clickclear(this, 'ค้นหา')" onblur="clickrecall(this,'ค้นหา')" onkeyup="serchtxt('daily_report/pout_list.php','p_list1',this)" /><input type="button" class="btn_serch" onclick="ajaxLoad('get','stock/druge_list.php','txt=','p_list')" />
			</div>
