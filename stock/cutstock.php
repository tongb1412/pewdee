...
<div style="width:65%; height:auto; float:left; margin-left:40px;">
	...
	<div style="width:100%; height:auto; float:left;">
		...
		<div class="line" style="height:20px;">
			<div style="width:15%; float:left; text-align:left;">ประเภท &nbsp;</div>	
			<div style="width:15%; float:left; text-align:left;">รหัสยา &nbsp;</div>		
			<div style="width:37%; float:left; text-align:left;">ชื่อยา &nbsp;</div>	
		...
		<div class="line" >		
			...
			<div style="width:37%; float:left;"><input type="text" id="dname" size="34"  style="border:1px solid #CCCCCC; background:#CCCCCC"   /></div>	
